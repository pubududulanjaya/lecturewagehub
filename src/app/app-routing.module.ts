...
const routes: Routes = [
  ...
  {path:'codashboard/:Department',component:CodashboardComponent},
  {path:'lecregister/:Department',component:LecregistrationComponent},
  ...
  {path:'add_modul/:Department',component:AddModuleComponent},
  {path:'add_batch/:Department',component:AddBatchComponent},
